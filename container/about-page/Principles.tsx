					...
					<div className="w-[50%] sm:w-full xm:w-full flex flex-col gap-[20px]">
						...
						<div className="flex flex-col gap-[20px]">
							<p className="paragraph font-NeueMontreal text-secondry">
								Flight Systems operate in an environement  <br />
								where failure is not an option.
								<br /> We design flight computers with reliability
								<br /> across our hardware, software and system architecture.
							</p>
						</div>
					</div>
					<div className="w-[50%] sm:w-full xm:w-full flex flex-col gap-[20px]">
						...
						<div className="flex flex-col gap-[20px]">
							<p className="paragraph font-NeueMontreal text-secondry">
								Aerospace systems evolves quickly.
								<br /> Our modular approach allows teams to integrate, adapt <br />
								and iterate without rebuilding entire systems from scratch, which <br />
                                is essential in time-critical deployment.
							</p>
						</div>
					</div>
				</div>
